...
class EmployeeIndex extends Component
{
    ...
    public function deleteEmployee($id)
    {
        ...
        $employee->delete();
        session()->flash('employee-message', 'Se eliminó el Empleado');
    }
    ...
    public function storeEmployee()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#employeeModal', 'actionModal' => 'hide']);
        session()->flash('employee-message', 'Se creó exitosamente el Empleado');
    }
    public function updateEmployee()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#employeeModal', 'actionModal' => 'hide']);
        session()->flash('employee-message', 'Se actualizó correctamente el empleado');
    }
