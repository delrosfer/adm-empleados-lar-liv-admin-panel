...
class CountryIndex extends Component
{
    ...
    public function deleteCountry($id)
    {
        ...
        $country->delete();
        session()->flash('country-message', 'Se eliminó el Pais');
    }
    ...
    public function storeCountry()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#countryModal', 'actionModal' => 'hide']);
        session()->flash('country-message', 'Se creó exitosamente el Pais');
    }
    public function updateCountry()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#countryModal', 'actionModal' => 'hide']);
        session()->flash('country-message', 'Se actualizó correctamente el pais');
    }
