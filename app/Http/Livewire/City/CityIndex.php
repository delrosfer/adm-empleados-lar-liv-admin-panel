...
class CityIndex extends Component
{
    ...
    public function deleteCity($id)
    {
        $city = City::find($id);
        $city->delete();
        session()->flash('city-message', 'Se eliminó la ciudad');
    }
    ...
    public function storeCity()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#cityModal', 'actionModal' => 'hide']);
        session()->flash('city-message', 'Se creó exitosamente la ciudad');
    }
    public function updateCity()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#cityModal', 'actionModal' => 'hide']);
        session()->flash('city-message', 'Se actualizó correctamente la ciudad');
    }
