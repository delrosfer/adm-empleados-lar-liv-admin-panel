...
class StateIndex extends Component
{
    ...
    public function deleteState($id)
    {
        $state = State::find($id);
        $state->delete();
        session()->flash('state-message', 'Se eliminó el Estado');
    }
    ...
    public function storeState()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#stateModal', 'actionModal' => 'hide']);
        session()->flash('state-message', 'Se creó exitosamente el Estado');
    }
    public function updateState()
    {
        ...
        $this->reset();
        $this->dispatchBrowserEvent('modal', ['modalId' => '#stateModal', 'actionModal' => 'hide']);
        session()->flash('state-message', 'Se actualizó correctamente el estado');
    }
